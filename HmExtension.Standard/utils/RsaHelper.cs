...
public static class RsaHelper
{
    ...
    /// RSA的加密函数 string
    /// </summary>
    /// <param name="publicKey">公钥
    /// <param name="mStrEncryptString">需要加密的字符串
    ...
    /// RSA的加密函数 byte[]
    /// </summary>
    /// <param name="encryptString">需要加密的字节数组
    /// <param name="publicKey">公钥
    /// <returns>加密后的内容</returns>
    /// <exception cref="CryptographicException">The cryptographic service provider (CSP) cannot be acquired. </exception>
    ...
    /// RSA的解密函数  string
    /// </summary>
    /// <param name="mStrDecryptString">需要解密的字符串
    /// <param name="privateKey">私钥
    ...
    /// RSA签名
    /// </summary>
    /// <param name="hashbyteSignature">签名字节数据
    /// <param name="privateKey">私钥
    ...
    /// RSA签名
    /// </summary>
    /// <param name="mStrHashbyteSignature">签名字符串数据
    /// <param name="pStrKeyPrivate">私钥
    /// <returns>处理结果</returns>
    /// <exception cref="CryptographicException">The cryptographic service provider (CSP) cannot be acquired. </exception>
    /// <exception cref="CryptographicUnexpectedOperationException">The key is null.-or- The hash algorithm is null. </exception>
    ...
    /// RSA 签名验证
    /// </summary>
    /// <param name="deformatterData">反格式化字节数据
    /// <param name="publicKey">公钥
    /// <param name="hashbyteDeformatter">哈希字节数据
    /// <returns>处理结果</returns>
    /// <exception cref="CryptographicException">The cryptographic service provider (CSP) cannot be acquired. </exception>
    /// <exception cref="CryptographicUnexpectedOperationException">The key is null.-or- The hash algorithm is null. </exception>
    ...
    /// <param name="deformatterData">反格式化字节数据
    /// <param name="publicKey">公钥
    /// <param name="pStrHashbyteDeformatter">哈希字符串数据
    /// <returns>处理结果</returns>
    /// <exception cref="CryptographicException">The cryptographic service provider (CSP) cannot be acquired. </exception>
    /// <exception cref="CryptographicUnexpectedOperationException">The key is null.-or- The hash algorithm is null. </exception>
    ...
    /// RSA 签名验证
    /// </summary>
    /// <param name="pStrDeformatterData">反格式化字符串数据
    /// <param name="publicKey">公钥
    /// <param name="hashbyteDeformatter">哈希字节数据
    /// <returns>处理结果</returns>
    /// <exception cref="CryptographicException">The cryptographic service provider (CSP) cannot be acquired. </exception>
    ...
    /// RSA 签名验证
    /// </summary>
    /// <param name="pStrDeformatterData">格式字符串数据
    /// <param name="publicKey">公钥
    /// <param name="pStrHashbyteDeformatter">哈希字符串数据
    /// <returns>处理结果</returns>
    /// <exception cref="CryptographicException">The cryptographic service provider (CSP) cannot be acquired. </exception>
