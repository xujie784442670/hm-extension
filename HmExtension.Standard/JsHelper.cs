...
public class JsHelper
{
    ...
    /// 执行js Eval方法 支持多线程
    /// </summary>
    /// <param name="reString">Js代码
    /// <param name="para">方法名称
    /// <param name="MethodName">参数字符串(使用逗号分隔)
    ...
    /// </summary>
    /// <param name="reString">加载的js文本
    /// <param name="MethodName">方法名称
    /// <param name="para">参数字符串(使用逗号分隔)
    /// <returns></returns>
